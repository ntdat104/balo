    ...
    it("Số điện thoại chưa đăng kí", (done) => {
      ...
      chai
        ...
        .end((err, res) => {
          res.should.have.status(200);
          res.body.should.be.a("object");
          res.body.should.have.property("code").eql("9995");
          res.body.should.have.property("message").eql("User is not validated");
          done();
        });
    });
    it("Số điện thoại sai định dạng", (done) => {
      ...
      chai
        ...
        .end((err, res) => {
          ...
          res.body.should.have.property("message").eql("Parameter type is invalid");
          done();
        });
    });
    it("Số điện thoại sai định dạng", (done) => {
